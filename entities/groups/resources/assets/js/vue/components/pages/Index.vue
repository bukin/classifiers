      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          <div class="ibox-title">
            <router-link :to="{name: 'inetstudio.classifiers-package.groups.back.resource.create'}" class="btn btn-sm btn-primary btn-lg">Добавить</router-link>
          </div>
...
export default {
    name: 'classifiers-package_groups_pages_index',
    components: {
    ...
    data() {
      return {
        datatable: {
          attributes: {
            id: 'classifiers-package_groups_table'
          },
          options: {},
          events: {}
        }
    ...
    created: function() {
      ...
      const url = route('inetstudio.classifiers-package.groups.back.tables.index.table');
