<template>
  <div class="btn-nowrap">
    <router-link :to="{name: 'inetstudio.classifiers-package.entries.back.resource.edit', params: {id: itemProp.id}}" class="btn btn-xs btn-default m-r-xs">
...
export default {
  name: 'classifiers-package_entries_partials_tables_actions',
  props: {
    itemProp: {
      type: Object,
      required: true
